# Section B.2 — Checkpoint-count and spacing sensitivity

**Paper items:** Figure 6. Numbering follows the manuscript.

| Item | Location |
|---|---|
| Paper-facing data and tables | [results/app_b_2_checkpoint_windows/](../../results/app_b_2_checkpoint_windows/) |
...
```bash
python experiments/app_b_2_checkpoint_windows/analyze.py
```
