# Section 4.2 — Raw final-iterate response to terminal activity

**Paper items:** Figure 3. Numbering follows the manuscript.

| Item | Location |
|---|---|
| Paper-facing data and tables | [results/sec_4_2_raw_terminal_activity/](../../results/sec_4_2_raw_terminal_activity/) |
...
```bash
python experiments/sec_4_2_raw_terminal_activity/analyze.py
```
