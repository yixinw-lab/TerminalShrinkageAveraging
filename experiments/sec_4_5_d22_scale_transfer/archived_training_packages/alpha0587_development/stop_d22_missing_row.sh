#!/usr/bin/env bash
set -u
DOWNLOADS="${DOWNLOADS:-$HOME/Downloads}"; PIDFILE="$DOWNLOADS/d22_runpod_missing_row_supervisor.pid"; LATEST="$DOWNLOADS/d22_runpod_missing_row_latest"
...
sleep 2
echo '===== SUPERVISOR CHECK ====='; pgrep -fl 'runpod_d22_missing_row_supervisor_v[0-9]+\.sh|caffeinate.*runpod_d22_missing_row' || echo 'supervisor stopped'
