# Section 4.1 — Replicated interior shrinkage optimum

**Paper items:** Figure 2. Numbering follows the manuscript.

| Item | Location |
|---|---|
| Paper-facing data and tables | [results/sec_4_1_replicated_shrinkage/](../../results/sec_4_1_replicated_shrinkage/) |
...
```bash
python experiments/sec_4_1_replicated_shrinkage/analyze.py
```
